...
from detection.algo import detection
from communication.comm import communication
from todo.todo_app import todo



#from blogs.home import blogs
app = Flask(__name__)
from home import *
# Blueprints 
...
@app.route('/')
def Home():
    return render_template('autispot.html')
